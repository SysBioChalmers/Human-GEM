...
**Improved:**
- Cross-refs inconsistent across compartments: [**2**](https://github.com/SysBioChalmers/Human-GEM/blob/feat/reaction-xrefs/data/testResults/qc_annotation_issues.csv)

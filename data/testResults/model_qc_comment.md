...
:warning: **6** pre-existing finding(s), no regressions vs `feat/succinate-export`. Non-blocking. Gates: duplicate keys **0** :white_check_mark:, growth **1.9** :white_check_mark:.
...
:white_check_mark: unchanged &middot; :sparkles: improved vs `feat/succinate-export` &middot; :warning: pre-existing, non-blocking &middot; :x: regression

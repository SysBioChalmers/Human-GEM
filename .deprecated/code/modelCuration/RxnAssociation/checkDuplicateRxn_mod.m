function [modelOut, removedRxnInd, keptRxnInd, duplicateRxnSets] = checkDuplicateRxn_mod(model, method, removeFlag, printLevel, boundsFlag)
% MODIFIED FORM OF COBRA FUNCTION: checkDuplicateRxn
%
...
%                     end
                    ...
                    duplicateRxnSets = [duplicateRxnSets; {ind}];

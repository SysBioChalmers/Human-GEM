%
% FILE NAME:    repairBiomassProduction.m
% 
...
% 
% PURPOSE: Script to curate the model such that it is able to produce
%          biomass.
%
...
model.lb(ismember(model.rxns,{'HMR_9034'})) = -1;  % glucose

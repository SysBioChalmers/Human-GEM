...
ihuman.rxnBiGGID = [ihuman.rxnBiGGID(1:r_ind(1)); {'HMGCOAtm'}; ihuman.rxnBiGGID((r_ind(1)+1):r_ind(2)); {'HMGCOAtx'}; ihuman.rxnBiGGID((r_ind(2)+1):end)];
...
ihuman.rxnRecon3DID = [ihuman.rxnRecon3DID(1:r_ind(1)); {'HMGCOAtm'}; ihuman.rxnRecon3DID((r_ind(1)+1):r_ind(2)); {'HMGCOAtx'}; ihuman.rxnRecon3DID((r_ind(2)+1):end)];

function grRules_clean = cleanModelGeneRules(grRules,deepClean)
...
% USAGE:
%
%   grRules_clean = cleanModelGeneRules(grRules,simplify);
%
%
% INPUT:
%
...
%
%   deepClean       (Optional, default TRUE). If TRUE, rules containing
%                   both ANDs and ORs will be further processed to remove
%                   duplicate groups of genes joined by ANDs or ORs, and 
%                   will remove duplicate genes or gene groups despite
%                   being separated by additional rules or parentheses.
%                   
%               For example:
%
%                 orig: G1 or G2 or (G3 and G4) or (G4 and G3 and G3) or G1
%
%                clean: G1 or G2 or (G3 and G4) or (G3 and G4) or G1
%
%            deepClean: (G3 and G4) or G1 or G2
%
%
% OUTPUT:
%
%   grRules_clean   Updated/cleaned grRules.
%
%
% Jonathan Robinson, 2018-07-24

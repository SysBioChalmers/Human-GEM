...
%
%
% The script also adds additional protein-specific fields to the model:
%
...
[~,ind] = ismember('HMR_4137',ihuman.rxns);
...
[~,ind] = ismember({'FAS100COA','FAS120COA','FAS140COA','FAS160COA','FAS180COA','KAS8'},ihuman.rxns);
grRules(ind) = {''};
...
[~,ind] = ismember({'BGAL1l','BGAL2l'},ihuman.rxns);
